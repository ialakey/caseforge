...
<p align="center">
  <img src="docs/screenshots/ru/bonus-teaser.png" alt="Главная страница с лентой дропов над шапкой" width="900">
</p>

<p align="center">
  <em>Лента дропов идёт над шапкой на всех страницах, слева к ней закреплён лучший дроп за сутки. Она не листается, а обрезается: новый дроп вытесняет самый старый, поэтому вся она читается без единого жеста.</em>
</p>
