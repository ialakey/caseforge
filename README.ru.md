...
Этапы 1–3 из дорожной карты (раздел 14 архдока), кроме депозита предметами. Не
реализованы: настоящие платежи, депозит предметов из Steam, KYC и полноценные
отчёты CRM из четвёртого этапа.
