...
<p align="center">
  <em>Каждое поле рисуется из реестра вместе с ключом — поэтому настройка, добавленная в общий пакет, появляется здесь без единой правки панели. Группы батлов и рефералов появились именно так.</em>
</p>
