...
<p align="center">
  <img src="docs/screenshots/inventory.png" alt="Инвентарь с фильтром по доступным предметам, у каждого кнопки продажи и вывода" width="900">
</p>
...
<p align="center">
  <img src="docs/screenshots/inventory-history.png" alt="Вкладка истории инвентаря с проданными, выведенными и вложенными предметами" width="900">
</p>
...
<p align="center">
  <img src="docs/screenshots/contract.png" alt="Контракт из пяти вложенных предметов и полная таблица возможных исходов" width="900">
</p>
...
<p align="center">
  <img src="docs/screenshots/bonus-wheel.png" alt="Колесо ежедневного бонуса с восемью секторами призов и кнопкой вращения" width="900">
</p>
