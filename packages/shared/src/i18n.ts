...
const ru = {
  ...
  'admin.promo.featured': 'На главной',
  'admin.promo.featuredHint':
    'Показывать этот код на главной странице. Отдельно от «активен»: код, выданный одному стримеру или конкретному игроку, активен и на витрине быть не должен.',
  'giveaway.title': 'Раздача скинов',
  'giveaway.winners': 'Список победителей',
  'giveaway.entrants': 'Участников',
  'giveaway.enter': 'Участвовать',
  'giveaway.entered': 'Я участвую',
  'giveaway.closed': 'Розыгрыш завершён',
  'giveaway.howTo': 'Как принять участие',
  'giveaway.step1': 'Пополните баланс от {amount}',
  'giveaway.step2': 'Нажмите «Участвовать»',
  'giveaway.yourDeposits': 'Ваши пополнения: {have} из {need}',
  'giveaway.topUp': 'Пополнить',
  'giveaway.signIn': 'Войдите, чтобы участвовать',
  'giveaway.wonBy': 'Выиграл',
  'giveaway.noEntrants': 'Никто не участвовал',
  'giveaway.verify': 'Проверить розыгрыш',
  'giveaway.seedHash': 'Хеш серверного сида',
  'giveaway.seed': 'Серверный сид',
  'giveaway.clientSeed': 'Клиентский сид (из списка участников)',
  'giveaway.roll': 'Ролл',
  'giveaway.historyTitle': 'Победители раздач',
  'giveaway.historyEmpty': 'Розыгрышей пока не было.',
  'error.GIVEAWAY_CLOSED': 'Розыгрыш не принимает заявки',
  'error.GIVEAWAY_DEPOSIT_REQUIRED': 'Не хватает пополнения с момента начала розыгрыша',
  'error.GIVEAWAY_ALREADY_ENTERED': 'Вы уже участвуете',
  'setting.appearance.giveaways.label': 'Главная: раздача скинов',
  'setting.appearance.giveaways.hint':
    'Секция с разыгрываемыми скинами, таймером и счётчиком участников. Сами розыгрыши заводятся в разделе «Раздачи»; здесь решается только, показывать ли их на главной.',
  'admin.nav.giveaways': 'Раздачи',
  'admin.giveaways.title': 'Раздача скинов',
  'admin.giveaways.hint':
    'Победитель определяется тем же provably fair аппаратом, что и открытие кейса: хеш сида публикуется сразу, сам сид — после розыгрыша, а клиентский сид считается из списка участников. Поэтому выбрать удачный момент нельзя.',
  'admin.giveaways.prize': 'Приз',
  'admin.giveaways.name': 'Название',
  'admin.giveaways.minDeposit': 'Порог пополнения',
  'admin.giveaways.opensAt': 'Старт',
  'admin.giveaways.drawsAt': 'Розыгрыш',
  'admin.giveaways.create': 'Создать раздачу',
  'admin.giveaways.cancel': 'Отменить',
  'admin.giveaways.empty': 'Раздач пока нет.',
  'admin.giveaways.pickItem': 'Найдите предмет по названию',
  'home.stats.cases': 'Кейсы',
  'home.stats.contracts': 'Контракты',
  'home.stats.upgrades': 'Апгрейды',
  'home.stats.battles': 'Сражения',
  'home.stats.users': 'Пользователи',
  'home.stats.online': 'Онлайн',
  'home.promo.bonusTitle': 'Ежедневный бонус',
  'home.promo.bonusReady': 'ДОСТУПЕН СЕЙЧАС',
  'home.promo.bonusIn': 'ДОСТУПЕН ЧЕРЕЗ',
  'home.promo.bonusCta': 'Крутить',
  'home.promo.codeTitle': 'Бонус к пополнению',
  'home.promo.codeNone': 'Сейчас акций нет',
  'home.promo.copy': 'Копировать',
  'home.promo.copied': 'Скопировано',
  'setting.appearance.statsBar.label': 'Главная: строка счётчиков',
  'setting.appearance.statsBar.hint':
    'Открыто кейсов, контракты, апгрейды, сражения, игроки и кто сейчас онлайн. На только что запущенном сайте это маленькие числа, а маленькие числа говорят ровно обратное тому, ради чего строка нужна.',
  'setting.appearance.promoCards.label': 'Главная: промо-ряд',
  'setting.appearance.promoCards.hint':
    'Ежедневный бонус с обратным отсчётом и действующий промокод на пополнение — рядом, под счётчиками.',
...
const en: Record<TranslationKey, string> = {
  ...
  'admin.promo.featured': 'On the landing page',
  'admin.promo.featuredHint':
    'Advertise this code on the landing page. Separate from "active": a code given to one streamer or to a single player is active and has no business on the shop front.',
  'giveaway.title': 'Skin giveaway',
  'giveaway.winners': 'Past winners',
  'giveaway.entrants': 'Entrants',
  'giveaway.enter': 'Enter',
  'giveaway.entered': 'You are in',
  'giveaway.closed': 'Drawn',
  'giveaway.howTo': 'How to enter',
  'giveaway.step1': 'Top up at least {amount}',
  'giveaway.step2': 'Press "Enter"',
  'giveaway.yourDeposits': 'Your top-ups: {have} of {need}',
  'giveaway.topUp': 'Top up',
  'giveaway.signIn': 'Sign in to enter',
  'giveaway.wonBy': 'Won by',
  'giveaway.noEntrants': 'Nobody entered',
  'giveaway.verify': 'Check the draw',
  'giveaway.seedHash': 'Server seed hash',
  'giveaway.seed': 'Server seed',
  'giveaway.clientSeed': 'Client seed (from the entrant list)',
  'giveaway.roll': 'Roll',
  'giveaway.historyTitle': 'Giveaway winners',
  'giveaway.historyEmpty': 'Nothing has been drawn yet.',
  'error.GIVEAWAY_CLOSED': 'This giveaway is not taking entries',
  'error.GIVEAWAY_DEPOSIT_REQUIRED': 'Not enough topped up since the giveaway opened',
  'error.GIVEAWAY_ALREADY_ENTERED': 'You are already entered',
  'setting.appearance.giveaways.label': 'Landing page: skin giveaways',
  'setting.appearance.giveaways.hint':
    'The section with the skins being given away, their countdown and the entrant count. The giveaways themselves are created under "Giveaways"; this only decides whether they appear on the landing page.',
  'admin.nav.giveaways': 'Giveaways',
  'admin.giveaways.title': 'Skin giveaways',
  'admin.giveaways.hint':
    'The winner is drawn on the same provably fair machinery as a case opening: the seed hash is published at once, the seed only after the draw, and the client seed is computed from the entrant list. There is no favourable moment to pick.',
  'admin.giveaways.prize': 'Prize',
  'admin.giveaways.name': 'Name',
  'admin.giveaways.minDeposit': 'Top-up threshold',
  'admin.giveaways.opensAt': 'Opens',
  'admin.giveaways.drawsAt': 'Draws',
  'admin.giveaways.create': 'Create a giveaway',
  'admin.giveaways.cancel': 'Cancel',
  'admin.giveaways.empty': 'No giveaways yet.',
  'admin.giveaways.pickItem': 'Find an item by name',
  'home.stats.cases': 'Cases',
  'home.stats.contracts': 'Contracts',
  'home.stats.upgrades': 'Upgrades',
  'home.stats.battles': 'Battles',
  'home.stats.users': 'Players',
  'home.stats.online': 'Online',
  'home.promo.bonusTitle': 'Daily bonus',
  'home.promo.bonusReady': 'READY NOW',
  'home.promo.bonusIn': 'AVAILABLE IN',
  'home.promo.bonusCta': 'Spin',
  'home.promo.codeTitle': 'Top-up bonus',
  'home.promo.codeNone': 'No promotion running',
  'home.promo.copy': 'Copy',
  'home.promo.copied': 'Copied',
  'setting.appearance.statsBar.label': 'Landing page: the counters bar',
  'setting.appearance.statsBar.hint':
    'Cases opened, contracts, upgrades, battles, registered players and who is online right now. On a site that has just opened these are small numbers, and small numbers say the opposite of what the bar is for.',
  'setting.appearance.promoCards.label': 'Landing page: the promo row',
  'setting.appearance.promoCards.hint':
    'The daily bonus with its countdown and the active top-up promo code, side by side under the counters.',
